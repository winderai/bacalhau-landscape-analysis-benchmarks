...
For convienence I'd recommend using [iTerm2 broadcast input](https://christopher.su/notes/mac/iterm-broadcast/) to quickly issue commands across multiple machines.
